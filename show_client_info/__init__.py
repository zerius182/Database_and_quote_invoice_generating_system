...
class ClientInfoDisplay(ClientMarkFunctions, AddNewClientRef, AddNote, AddToMatAndLab, MatAndLabListBoxPopulate,
    ...
    """Class containing Client Info Display methods"""
    def __init__(self):
    ...
    def populate_client_info_page(self, key, sci_frame, sci_root):
        """Populates client info page with selected client[key]"""
        ...
        # client info frame and client details
        ...
        # Contact details frame and labels
    ...
    def mark_quote_sent(self):
        """Creates messagebox asking to confirm whether client wants to mark as quote sent"""
    ...
    def mark_quote_accepted(self):
        """Creates quote accepted messagebox"""
    ...
    def mark_quote_declined(self):
        """Creates quote declined messagebox"""
    ...
    def mark_as_invoice_sent(self):
        """Creates invoice sent messagebox"""
    ...
    def mark_as_paid(self):
        """Creates mark as paid messagebox"""
    ...
    def option_function(self, event):
        """Takes passed in option and calls relevant function"""
    ...
    def add_client_ref_top_level_maker(self):
        """Opens add client reference toplevel"""
    ...
    def add_client_ref_button_function(self, event):
        """Bound to button in add client toplevel, calls function that adds inputted reference to client dictionary"""
    ...
    def add_note_button_function(self, event):
        """Bound to button in add note toplevel, calls function that adds inputted reference to client dictionary"""
    ...
    def add_to_materials_and_labour(self):
        """Removes open frames and calls function to create add to materials page"""
        sci_sounds.play_click()
    ...
    def view_materials_and_labour_toplevel_maker(self):
        """Creates toplevel to display materials and labour"""
    ...
    def back_to_client(self, event):
        """Destroys atmal frame and recalls populate_client_info method"""
        sci_sounds.play_click()
    ...
    def add_payment_to_dict(self, event):
        """Call add payment method and adds payment to client dictionary"""
        sci_sounds.play_click()
    ...
    def view_notes_toplevel_maker(self):
        """Creates notes toplevel to view client notes"""
    ...
    def back_from_cci(self):
        """Destroys cci frame and repopulates client info"""
        self.cci_info_frame.destroy()
        self.populate_client_info_page(self.client_info_key, self.sci_frame, self.sci_root)

    def open_change_client_info(self):
        """Destroys sci frame and calls method to create cci page"""
        sci_sounds.play_click()
