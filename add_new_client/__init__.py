...
class AddNewClient(DataCreator, ClientListPopulate, FavouriteInfoDictCreate):
    ...
    def start_anc_page(self, main_frame, main_root):
        ...
        # Customer Address Entry labels and entry boxes
        ...
        # email and phone labels and entry boxes
        ...
        # Service address and notes labels and entryboxes
    ...
    def open_favourites(self, event):
        """Opends toplevel populated by favourite clients"""
